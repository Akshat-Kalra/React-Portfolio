...
function Projects() {
  return (
    <section className={styles.container}>
        ...
        <Project img={fitLift} name="FitTrackr" description='Java-based fitness tracking app. Logs workouts, visualizes progress, and persists data.' link="https://github.com/Akshat-Kalra/FitTrackr" skills={<strong>Java | Swing (GUI) | JUnit5</strong>}/>
